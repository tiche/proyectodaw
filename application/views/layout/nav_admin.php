        ...
        <div class="collapse navbar-collapse" id="navbarNav"><!--collapse navbar-collapse define la zona que se va a colapsar cuando la pantalla sea pequeña-->
            <ul class="navbar-nav ml-auto"><!---La clase ml-auto es lo que hace que se vayan hacia la derecha los ítems del menú-->
                <li class="nav-item dropdown">
                   <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Gestor</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?= base_url('') ?>">Usuarios</a>
                        <a class="dropdown-item" href="<?= base_url('') ?>">Entradas</a>
                        <a class="dropdown-item" href="<?= base_url('') ?>">Ofertas</a>                      
                    </div>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('user/perfil') ?>"><i class="fas fa-user"></i> <?=$this->session->userdata('nombre_usuario')?></a>
                </li>
                <li class="nav-item">
